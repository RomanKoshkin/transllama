...
# load the model and tokenizer. The model is merged with the adapter
tokenizer = AutoTokenizer.from_pretrained(MODEL_NAME, cache_dir=os.environ['HF_HOME'], device_map="auto")
...
class Agent(SpeechToTextAgent):
    ...
    asr_model = ASR(ASR_MODEL_NAME, 'cuda', SRATE)
    input_words = []
