...
TRAIN_DS_PATH = '../data/mustc2_enru_aligned_dict_4000_train.json'
VALID_DS_PATH = '../data/mustc2_enru_aligned_dict_4000_valid.json'
...
JUNK += list(range(30100, len(REV_VOCAB)))
[JUNK.remove(i) for i in [i for i in range(30100, 31500) if contains_russian_chars(REV_VOCAB[i])]]
JUNK = list(set(JUNK))
