...
def add_dataloader_args(parser: argparse.ArgumentParser, cli_argument_list: Optional[List[str]] = None):
...
def general_parser():
    ...
    parser.add_argument("--slurm", action="store_true", default=False, help="Use slurm.")
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="How many beams to use in generation. Overrides the config value.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Beam depth. Overrides the config value.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Wait_k. Overrides the config value.",
    )

    parser.add_argument("--zero_shot",
                        action="store_true",
                        default=False,
                        help="Whether to use the base model. Default: false. Overrides the config value.")
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Minimum number of words the translation model will lag behind the source words.",
    )
...
def add_slurm_args(parser):
    parser.add_argument("--slurm-partition", default="learnaccel,ust", help="Slurm partition.")
